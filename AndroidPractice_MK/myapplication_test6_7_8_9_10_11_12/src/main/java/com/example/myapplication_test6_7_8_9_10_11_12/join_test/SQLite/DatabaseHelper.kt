...
class DatabaseHelper(context: Context?) : SQLiteOpenHelper
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        db.execSQL("create table " + TABLE_NAME +
                "(ID INTEGER PRIMARY KEY AUTOINCREMENT, NAME TEXT, PASSWORD TEXT, EMAIL TEXT, PROFILEIMAGE TEXT)")
    }
    ...
    // 데이터베이스 추가하기 insert
    fun insertData(name: String?, password: String?, email: String?, profileimage: String?): Boolean {
    ...
    //데이터베이스 수정하기
    fun updateData(id: String, name: String?, password: String?, email: String?, profileimage: String?): Boolean {
        val db = this.writableDatabase
        val contentValues = ContentValues()
    ...
    companion object {
        ...
        const val DATABASE_NAME = "USER.db" // 데이터베이스 명
