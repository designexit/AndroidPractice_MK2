package com.example.myapplication_test6_7_8_9_10_11_12.ch17_test.SQLiteTest
...
import com.example.myapplication_test6_7_8_9_10_11_12.databinding.ActivityDatabaseTestBinding
...
class DatabaseTestActivity : AppCompatActivity() {
    ...
    lateinit var binding: ActivityDatabaseTestBinding
...
//        setContentView(R.layout.activity_main)
    ...
    fun AddData() {
        buttonInsert!!.setOnClickListener {
            ...
            if (isInserted == true)
                Toast.makeText(this@DatabaseTestActivity, "데이터추가 성공", Toast.LENGTH_LONG)
                    .show()
            else Toast.makeText(this@DatabaseTestActivity, "데이터추가 실패", Toast.LENGTH_LONG).show()
        }
    }
    ...
    fun UpdateData() {
        buttonUpdate!!.setOnClickListener {
            ...
            if (isUpdated == true)
                Toast.makeText(this@DatabaseTestActivity, "데이터 수정 성공", Toast.LENGTH_LONG)
                    .show()
            else Toast.makeText(this@DatabaseTestActivity, "데이터 수정 실패", Toast.LENGTH_LONG)
                .show()
        }
    }
    ...
    fun DeleteData() {
        buttonDelete!!.setOnClickListener {
            ...
            if (deleteRows > 0)
                Toast.makeText(this@DatabaseTestActivity, "데이터 삭제 성공", Toast.LENGTH_LONG)
                    .show()
            else Toast.makeText(this@DatabaseTestActivity, "데이터 삭제 실패", Toast.LENGTH_LONG)
                .show()
        }
    }
