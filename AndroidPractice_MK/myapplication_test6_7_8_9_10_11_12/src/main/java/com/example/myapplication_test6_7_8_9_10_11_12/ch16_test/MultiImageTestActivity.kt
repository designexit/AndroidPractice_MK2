...
import com.example.myapplication_test6_7_8_9_10_11_12.ch16_test.adapter.MultiImageAdapter
import com.example.myapplication_test6_7_8_9_10_11_12.databinding.ActivityMultiImageTestBinding
import java.io.File
import java.text.SimpleDateFormat
import java.util.Date

class MultiImageTestActivity : AppCompatActivity() {
    lateinit var binding : ActivityMultiImageTestBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMultiImageTestBinding.inflate(layoutInflater)
        setContentView(binding.root)

        //갤러리 버튼 클릭 시 이벤트 처리하는 부분 -> 후처리 재사용 하고 속성 몇개 고치기
